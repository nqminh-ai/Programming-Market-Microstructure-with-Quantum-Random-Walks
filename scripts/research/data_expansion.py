...
Usage
-----
    python scripts/research/data_expansion.py [--skip-existing] [--skip-missing]
"""
...
def process_day(
    ...
    try:
        ...
        report = report_dir / f"data_quality_{sym}_{date_token}.txt"
...
def featurize_day(
    ...
    try:
        ...
        metadata_dir = reports_dir / "feature_metadata"
        stats_dir = reports_dir / "feature_stats"
        metadata_dir.mkdir(parents=True, exist_ok=True)
        stats_dir.mkdir(parents=True, exist_ok=True)
        metadata_path = metadata_dir / f"feature_metadata_{sym}_{date_token}.json"
        stats_path = stats_dir / f"feature_stats_{sym}_{date_token}.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "(use --no-skip-missing to fail instead)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
