# Heavy-tailed unitary shift — tail-shape evaluation (ETHUSDT)
...
- Feature file: `features_ETHUSDT_2026-06-12.parquet` (1,000,000 rows), tick size 0.01
...
|---:|---:|---:|---:|---:|:--:|
| 0.3 | 11.40 | 75.35 | 4.806 | 5.8e-05 | ✘ wrap |
| 0.5 | 5.85 | 25.55 | 3.057 | 5.4e-07 | ✔ |
| 0.7 | 3.62 | 7.74 | 1.384 | 6.9e-06 | ✔ |
| 0.9 | 1.62 | 3.10 | 0.343 | 4.7e-06 | ✔ |
| 1.0 *(ordinary)* | 1.12 | 1.15 | 1.699 | 2.2e-29 | ✔ |
| 1.3 | 1.17 | 1.23 | 1.585 | 2.7e-07 | ✔ |
| 1.6 | 1.56 | 3.15 | 0.395 | 1.3e-05 | ✘ wrap |
| 2.0 | 1.81 | 1.90 | 0.718 | 7.1e-07 | ✔ |

## Verdict

The heavy-tailed unitary (alpha=0.9) matches the empirical tail shape better than the ordinary walk (shape distance 0.343 vs 1.699). The ordinary walk's marginal is bimodal/ballistic with q999/q75 = 1.15, against an empirical 3.09; the Lévy shift reaches 3.10.
